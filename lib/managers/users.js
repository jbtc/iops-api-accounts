...
//      .then(function(user) {
//        return self.collection.updateAsync({ _id: self.toObjectId(id) }, user);
//      });
//  } else {
//    return this.collection.updateAsync({ _id: self.toObjectId(id) }, user);
//  }
//};
//
